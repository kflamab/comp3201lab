...
public class NoteBookWindow extends Application {
	...
	private HBox addHBox() {
		...
		clearSearch.setOnAction(new EventHandler<ActionEvent>() {
		 ...
		 hbox.getChildren().addAll(buttonLoad, buttonSave, searchLabel, searchTextField, searchBtn, clearSearch);
		...
		// currentFolder
		 if (!currentSearch.equals("")){
			...
			for (Folder folder : noteBook.getFolders()){
				...
				foundNotes.addAll(folder.searchNote(currentSearch));
			...
			for (Folder folder : noteBook.getFolders()){
				...
				if (folder.getName().equals(currentFolder)){
					...
					for (Note note : folder.getNotes()){
						System.out.println("I am inside the loops, the folder name = " + folder.getName());
						System.out.println("I am inside the loops, the note name = " + note.getTitle());
						list.add(note.getTitle());
					}
				}
			}
